...
<button type="button" class="btn btn-primary mt-5 text-dark">
    Nombres de Clients <span class="badge text-bg-dark">{{ $test }}</span>
  </button>
  <button type="button" class="btn btn-primary mt-5 text-dark">
    Nombres de Candidat <span class="badge text-bg-dark">{{ $test1 }}</span>
  </button>
        <main class="py-4">
        @yield('content')
        </main>
